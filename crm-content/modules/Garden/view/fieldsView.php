								...
								<template v-if="key === 'type'">
									<div class="form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<select class="form-control col-md-7 col-xs-12" v-bind:id="key" v-model="record[key]">
												<option value=""></option>
												<option value="text">Texto - Campo de texto de línea simple.</option>
												<option value="color">Color - Control para espicificar un color.</option>
												<option value="date">Fecha Corta - Control para introducir una fecha (año, mes y día, sin tiempo).</option>
												<option value="datetime-local">Fecha Completa - Control para introducir fecha y hora, sin zona horaria específica.</option>
												<option value="email">Correo Electronico - Campo para introducir una dirección de correo electrónico.</option>
												<option value="month">Mes y Año - Control para introducir un mes y año, sin zona horaria específica.</option>
												<option value="number">Numero - Control para introducir un número de punto flotante.</option>
												<option value="tel">Teléfono - Control para introducir un número telefónico</option>
												<option value="time">Hora - Control para introducir un valor de tiempo sin zona horaria específica.</option>
												<option value="url">Enlace - Campo para editar una URL.</option>
												<option value="week"># Semana - Control para introducir una fecha que consiste en número de semana del año y número de semana sin zona horaria específica.</option>
											</select>
...
app = new Vue({
  ...
  mounted: function () {
	  this.$router.push({path: '/garden_fields/list'});
  },
  created: function () {
    var self = this;
